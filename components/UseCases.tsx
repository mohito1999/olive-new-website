...
const UseCases: React.FC = () => {
    ...
    const tabs = [
        ...
        },
        {
            ...
            desc: "Boosts show-up rates for lead magnets.",
            tag: "The Shepherd",
        },
        {
            icon: Wheat,
                ...
                <div className="lg:w-1/3 flex flex-col gap-4">
                    {tabs.map((tab, idx) => (
                        <button
                            ...
                            className={`text-left p-5 rounded-2xl transition-all duration-300 flex items-start gap-4 ${activeTab === idx
    ...
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="relative w-full max-w-sm">
            ...
            >
                ...
                <div>
                    <div className="text-xs font-bold text-stone-900">New Lead: Loan Inquiry</div>
            ...
            >
                ...
                <div className="text-center py-4">
                    ...
                    <div className="text-white font-bold">Kartik Kumar</div>
                    <div className="text-stone-500 text-xs">+91 9876543210</div>
                </div>
            </motion.div>
    ...
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="w-full max-w-sm space-y-4">
            ...
            >
                ...
                <div className="text-white font-bold">Investing Workshop</div>
            ...
            >
                <div className="text-stone-200 text-xs">
                    Hi Anjali! Ready to learn how to make smart investments? Here is your link for tomorrow: zoom.us/j/9...
                </div>
            </motion.div>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="w-full max-w-sm">
            ...
            <div className="bg-stone-800 rounded-lg overflow-hidden mb-8 border border-stone-700">
                ...
                <div className="flex p-3 text-xs text-stone-300 items-center">
                    <div className="w-1/3">Sidharth</div>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="w-full max-w-sm flex items-center justify-center gap-4">
            ...
            <div className="w-1/2 space-y-2">
                ...
                <div className="bg-stone-800 p-3 rounded-lg text-[10px] text-stone-400 border border-stone-700 leading-relaxed">
                    "Client said credit score is 740 and property value is around ₹1cr."
                </div>
            </div>
            ...
            <div className="w-1/2 space-y-2">
                ...
                >
                    ...
                    <div>
                        ...
                        <div className="text-xs font-bold text-stone-900">₹1cr</div>
                    </div>
                    <div>
