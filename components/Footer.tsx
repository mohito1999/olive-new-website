    ...
    <footer className="bg-stone-950 pt-32 pb-12 px-6 w-full border-t border-stone-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center relative z-10">
        ...
        <h2 className="text-4xl md:text-6xl font-bold text-white mb-8 tracking-tight leading-tight">
          Ready to hire your first <br className="hidden md:block" />
          <span className="text-olive-500">AI Employee?</span>
        </h2>

        <p className="text-stone-400 text-lg max-w-2xl mb-12">
          Join the forward-thinking companies automating their sales pipeline with Olive. Scale your outreach without scaling your headcount.
        </p>

        <div className="mb-24">
          <button className="group bg-white hover:bg-stone-200 text-stone-950 px-10 py-5 rounded-full text-lg font-bold transition-all shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)] hover:shadow-[0_0_60px_-10px_rgba(255,255,255,0.5)] hover:-translate-y-1 flex items-center gap-3">
            Book a Demo
