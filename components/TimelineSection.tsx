        ...
        <section className="py-32 px-6 bg-stone-950 w-full overflow-hidden text-white relative">
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                <div className="relative">
                    ...
                    <div className="absolute left-1/2 top-0 bottom-0 w-1 bg-stone-800 -translate-x-1/2 rounded-full overflow-hidden">
                        <motion.div
                    ...
                    <div className="space-y-24">
                        ...
                        <div className="relative flex items-center justify-center w-full">
                            <div className="absolute left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-stone-950 border-2 border-stone-600 z-10"></div>
                        ...
                        <div className="relative flex items-center justify-center w-full">
                            <div className="absolute left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-stone-950 border-2 border-olive-500 z-10 shadow-[0_0_10px_rgba(16,185,129,0.5)]"></div>
                        ...
                        <div className="relative flex flex-col items-center justify-center w-full pt-8">
                            <div className="w-8 h-8 rounded-full bg-olive-500 flex items-center justify-center text-white relative z-10 shadow-[0_0_20px_rgba(16,185,129,0.6)]">
                            ...
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                className="mt-8 bg-white text-stone-900 rounded-xl p-4 shadow-2xl flex items-center gap-4 w-72"
                            >
